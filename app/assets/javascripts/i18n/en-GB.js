...
I18n.translations["en-GB"] = I18n.extend((I18n.translations["en-GB"] || {}), {
  ...
  "javascripts": {
    ...
    "directions": {
      ...
      "instructions": {
        ...
        "offramp_left_with_name_directions": "Take the sliproad on the left onto %{name}, towards %{directions}",
        ...
        "offramp_right_with_name_directions": "Take the sliproad on the right onto %{name}, towards %{directions}",
        "onramp_left": "Turn left onto the ramp",
        "onramp_left_with_directions": "Turn left onto the sliproad towards %{directions}",
        "onramp_left_with_name_directions": "Turn left on the sliproad onto %{name}, towards %{directions}",
        ...
        "onramp_right_with_name_directions": "Turn right on the sliproad onto %{name}, towards %{directions}",
  ...
  "site": {
    ...
    "index": {
      "remote_failed": "Editing failed - make sure JOSM or Merkaartor is loaded and that the remote control option is enabled"
    },
    "sidebar": {
